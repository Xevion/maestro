...
public class ElytraCommand extends Command {
    ...
    private Component suggest2b2tSeeds() {
        ...
        clippy.append(
                "Within a few hundred blocks of spawn/axis/highways/etc, the terrain is too"
                    + " fragmented to be predictable. Baritone Elytra will still work, just with"
                    + " backtracking. ");
    ...
    private void gatekeep() {
        ...
        gatekeep.append(
                "Baritone Elytra is an experimental feature. It is only intended for long distance"
        ...
        MutableComponent gatekeep2 =
                Component.literal(
                        "If you want Baritone to attempt to take off from the ground for you, you"
        ...
        MutableComponent gatekeep3 =
                Component.literal(
                        "If you want Baritone to go slower, enable the elytraConserveFireworks"
        ...
        if (detectOn2b2t()) {
            ...
            if (Baritone.settings().elytraNetherSeed.value == NEW_2B2T_SEED) {
                MutableComponent gatekeep5 =
                        Component.literal(
                                "Baritone doesn't know the seed of your world. Set it with: "
                                        + Baritone.settings().prefix.value
                ...
                if (Baritone.settings().elytraPredictTerrain.value) {
                    ...
                    MutableComponent gatekeep5 =
                            Component.literal(
                                    "Baritone Elytra is not predicting terrain. If you don't know"
