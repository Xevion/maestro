 ...
 * because you AREN'T SUPPOSED TO USE THIS to pause and resume Baritone. Make your own process that
...
public class ExecutionControlCommands {
    ...
    public ExecutionControlCommands(IBaritone baritone) {
        ...
        pauseCommand =
                new Command(baritone, "pause", "p", "paws") {
                    @Override
                    ...
                    public List<String> getLongDesc() {
                        return Arrays.asList(
                                "The pause command tells Baritone to temporarily stop whatever it's"
                                        + " doing.",
                                "",
        ...
        resumeCommand =
                new Command(baritone, "resume", "r", "unpause", "unpaws") {
                    @Override
                    public void execute(String label, IArgConsumer args) throws CommandException {
                        args.requireMax(0);
                    ...
                    public List<String> getLongDesc() {
                        return Arrays.asList(
                                "The resume command tells Baritone to resume whatever it was doing"
        ...
        pausedCommand =
                new Command(baritone, "paused") {
                    ...
                    public List<String> getLongDesc() {
                        return Arrays.asList(
                                "The paused command tells you if Baritone is currently paused by"
        ...
        cancelCommand =
                new Command(baritone, "cancel", "c", "stop") {
                    ...
                    public List<String> getLongDesc() {
                        return Arrays.asList(
                                "The cancel command tells Baritone to stop whatever it's currently"
                                        + " doing.",
                                "",
                                "Usage:",
                                "> cancel");
