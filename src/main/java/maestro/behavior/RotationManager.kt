 ...
 */
class RotationManager(maestro: Agent) : Behavior(maestro) {
     ...
     */
    @JvmOverloads
    fun queue(yaw: Float, pitch: Float, priority: Int, callback: Runnable? = null) {
     ...
     */
    fun queue(rotation: Rotation, priority: Int, callback: Runnable? = null) {
