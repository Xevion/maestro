...
public final class GetToBlockProcess extends MaestroProcessHelper implements IGetToBlockProcess {
    ...
    public class GetToBlockCalculationContext extends CalculationContext {
        ...
        public GetToBlockCalculationContext(boolean forUseOnAnotherThread) {
            super(GetToBlockProcess.super.maestro, forUseOnAnotherThread);
        }
    ...
    private Goal createGoal(BlockPos pos) {
        ...
        if (blockOnTopMustBeRemoved(gettingTo.getBlock())
                && MovementHelper.isBlockNormalCube(
                        maestro.bsi.get0(pos.above()))) { // TODO this should be the check for chest
            // openability
