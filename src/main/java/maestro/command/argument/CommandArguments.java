...
import maestro.api.command.exception.CommandInvalidArgumentException;
...
public final class CommandArguments {
    ...
    /**
     * Turn a string into a list of {@link ICommandArgument}s. This is needed because of {@link
     * ICommandArgument#getRawRest()}
     *
     * @param string The string to convert
     * @param preserveEmptyLast If the string ends with whitespace, add an empty {@link
     *     ICommandArgument} to the end This is useful for tab completion
    ...
    public static List<ICommandArgument> from(String string, boolean preserveEmptyLast) {
        ...
        while (argMatcher.find()) {
            args.add(
                    new CommandArgument(
                            args.size(), argMatcher.group(), string.substring(argMatcher.start())));
    ...
    /**
     * Returns an "unknown" {@link CommandArgument}. This shouldn't be used unless you absolutely
     * have no information - ESPECIALLY not with {@link CommandInvalidArgumentException}s
     *
