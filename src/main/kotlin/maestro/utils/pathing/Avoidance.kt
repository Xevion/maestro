...
class Avoidance {
    ...
    companion object {
        ...
        fun create(ctx: IPlayerContext): List<Avoidance> {
            ...
            val mobSpawnerCoeff = Agent.settings().mobSpawnerAvoidanceCoefficient.value
            val mobCoeff = Agent.settings().mobAvoidanceCoefficient.value
            ...
            if (mobCoeff != 1.0) {
                ctx
                    ...
                    .filter { entity ->
                        ...
                        entity !is Spider || ctx.player().lightLevelDependentMagicValue < 0.5
                    }.filter { entity ->
