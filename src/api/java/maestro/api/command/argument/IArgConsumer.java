...
public interface IArgConsumer {
     ...
     *     indicated by a comamnd argument index that has a value of {@code -1}, if no arguments
    ...
    /**
     * @return The value of thelast argument this {@link IArgConsumer}} has consumed, or an empty
