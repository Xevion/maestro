...
public final class Settings {
    private static final Logger LOGGER = LoggerFactory.getLogger("Maestro");
     ...
     *
     * <p>Decrease to make Maestro more often consider paths that would require placing blocks
     */
     ...
     *
     * <p>If a schematic asks for a block on this mapping, Maestro will place the first placeable
    ...
    /** Whether or not to allow you to run Maestro commands with the prefix */
    ...
    public final Setting<Boolean> shortMaestroPrefix = new Setting<>(false);
     ...
     *
     * <p>For example, if Maestro is doing "mine iron_ore", the instant it breaks the ore (and it
     ...
     * space)
     *
     * <p>However, simply discarding old chunks because they are old is inadvisable. Maestro is
     * extremely good at correcting itself and its paths as it learns new information, as new chunks
     * load. There is no scenario in which having an incorrect cache can cause Maestro to get stuck,
     * take damage, or perform any action it wouldn't otherwise, everything is rechecked once the
     * real chunk is in range.
     *
     ...
     * chunkCaching setting is disabled and Maestro starts anew every time, or when you enter a
    ...
    public final Setting<BiConsumer<Component, Component>> toaster =
            new Setting<>(MaestroToast::addOrUpdate);
