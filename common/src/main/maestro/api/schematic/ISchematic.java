...
/**
 * Basic representation of a schematic. Provides the dimensions and the desired state for a given
...
public interface ISchematic {
     ...
     *
     * <p>Normally just a check for if the coordinate is in the cube.
     *
     * <p>However, in the case of something like a map art, anything that's below the level of the
     * map art doesn't matter, so this function should return false in that case. (i.e. it doesn't
     * really have to be air below the art blocks)
     *
     ...
     * @return Whether the specified position is within the bounds of this schematic
     */
    ...
    /**
     * Returns the desired block state at a given (X, Y, Z) position relative to the origin (0, 0,
     * 0).
     *
     * @param x The x position of the block, relative to the origin
     * @param y The y position of the block, relative to the origin
