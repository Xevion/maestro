...
public interface IArgParser<T> {
    ...
    /**
     * A stateless argument parser is just that. It takes a {@link ICommandArgument} and outputs its
     * type.
     */
    ...
    /**
     * A stated argument parser is similar to a stateless one. It also takes a {@link
     * ICommandArgument}, but it also takes a second argument that can be any type, referred to as
     * the state.
     */
