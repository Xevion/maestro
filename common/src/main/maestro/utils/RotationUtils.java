...
public final class RotationUtils {
    ...
    /**
     * Determines if the specified entity is able to reach the center of the sides of the specified
     * block. It first checks if the block center is reachable, and if so, that rotation will be
     * returned. If not, it will return the first center of a given side that is reachable. The
     * return type will be {@link Optional#empty()} if the entity is unable to reach any of the
     * sides of the block.
     *
     * @param ctx Context for the viewing entity
     * @param pos The target block position
