...
public interface IStaticSchematic extends ISchematic {
    ...
    /**
     * Returns an {@link BlockState} array of size {@link #heightY()} which contains all desired
     * block states in the specified vertical column. The index of {@link BlockState}s in the array
     * are equivalent to their Y position in the schematic.
     *
