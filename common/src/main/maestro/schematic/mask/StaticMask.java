package maestro.schematic.mask;

import maestro.schematic.mask.operator.BinaryOperatorMask;
import maestro.schematic.mask.operator.NotMask;
import maestro.utils.BooleanBinaryOperators;
import net.minecraft.world.level.block.state.BlockState;

/**
 * A mask that is context-free. In other words, it doesn't require the current block state to
 * determine if a relative position is a part of the mask.
 */
public interface StaticMask extends Mask {

    /**
     * Determines if a given relative coordinate is included in this mask, without the need for the
     * current block state.
     *
    ...
    /**
     * Implements the parent {@link Mask#partOfMask partOfMask function} by calling the static
     * function provided in this functional interface without needing the {@link BlockState}
     * argument. This {@code default} implementation should <b><u>NOT</u></b> be overriden.
     *
     * @param x The relative x position of the block
     * @param y The relative y position of the block
     * @param z The relative z position of the block
