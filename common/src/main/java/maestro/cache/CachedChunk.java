...
public final class CachedChunk {
     ...
     *
     * <p>Chunks are 16x16xH, each block requires 2 bits.
     */
     ...
     *
     * <p>Each block is expressed as 2 bits giving a total of 16 KiB
     */
    ...
    /**
     * Validates the size of an input {@link BitSet} containing the raw packed chunk data. Sizes
     * that exceed {@link CachedChunk#size} are considered invalid, and thus, an exception will be
     * thrown.
     *
