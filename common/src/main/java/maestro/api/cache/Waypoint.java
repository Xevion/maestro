...
public class Waypoint implements IWaypoint {
    ...
    /**
     * Constructor called when a Waypoint is read from disk, adds the creationTimestamp as a
     * parameter so that it is reserved after a waypoint is written to the disk.
     *
